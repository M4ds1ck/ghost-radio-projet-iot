...
const architectureLayers = [
  {
    key: 'perception',
    label: 'PERCEPTION',
    description: 'Sensing layer: radios, microphones, and physical RF acquisition.',
  },
  {
    key: 'reseau',
    label: 'R\u00c9SEAU',
    description: 'Transport layer: links and packet movement across the wireless path.',
  },
  {
    key: 'traitement',
    label: 'TRAITEMENT',
    description: 'Processing layer: GNU Radio modulation, filtering, and demodulation.',
  },
  {
    key: 'application',
    label: 'APPLICATION \u2605',
    description: 'Application layer: operator control, telemetry, orchestration, and replay.',
  },
]
          ...
          const detailLines =
            card.key === 'signal-normal'
              ...
              : card.key === 'scanner'
                ? [
                    'captured_target.raw',
                    `${fileSizeCount.toLocaleString('en-US')} bytes | ${durationCount.toFixed(1)} seconds`,
                    'samp_rate: 480,000 Hz',
                  ]
                : card.key === 'jamming'
                  ? [
